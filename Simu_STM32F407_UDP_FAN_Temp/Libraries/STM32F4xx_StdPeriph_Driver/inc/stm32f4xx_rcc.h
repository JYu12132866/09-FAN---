...
/** @defgroup RCC_HSE_configuration 
  * @{
  */
#define RCC_ETH_HSE_OFF                      ((uint8_t)0x00)
#define RCC_ETH_HSE_ON                       ((uint8_t)0x01)
#define RCC_HSE_Bypass                   ((uint8_t)0x05)
#define IS_ETH_RCC_HSE(HSE) (((HSE) == RCC_ETH_HSE_OFF) || ((HSE) == RCC_ETH_HSE_ON) || \
                         ((HSE) == RCC_HSE_Bypass))
/**
  * @}
  */ 
...
#define IS_RCC_ETH_PLLM_VALUE(VALUE) ((VALUE) <= 63)
#define IS_RCC_ETH_PLLN_VALUE(VALUE) ((192 <= (VALUE)) && ((VALUE) <= 432))
#define IS_RCC_ETH_PLLP_VALUE(VALUE) (((VALUE) == 2) || ((VALUE) == 4) || ((VALUE) == 6) || ((VALUE) == 8))
#define IS_RCC_ETH_PLLQ_VALUE(VALUE) ((4 <= (VALUE)) && ((VALUE) <= 15))
 
#define IS_RCC_ETH_PLLI2SN_VALUE(VALUE) ((192 <= (VALUE)) && ((VALUE) <= 432))
#define IS_RCC_ETH_PLLI2SR_VALUE(VALUE) ((2 <= (VALUE)) && ((VALUE) <= 7))  
...
#define IS_ETH_RCC_HCLK(HCLK) (((HCLK) == RCC_SYSCLK_Div1) || ((HCLK) == RCC_SYSCLK_Div2) || \
...
#define IS_ETH_RCC_PCLK(PCLK) (((PCLK) == RCC_HCLK_Div1) || ((PCLK) == RCC_HCLK_Div2) || \
...
/** @defgroup RCC_LSE_Configuration 
  * @{
  */
#define RCC_EHT_LSE_OFF                      ((uint8_t)0x00)
#define RCC_EHT_LSE_ON                       ((uint8_t)0x01)
#define RCC_EHT_LSE_Bypass                   ((uint8_t)0x04)
#define IS_RCC_ETH_LSE(LSE) (((LSE) == RCC_EHT_LSE_OFF) || ((LSE) == RCC_EHT_LSE_OFF) || \
                         ((LSE) == RCC_EHT_LSE_Bypass))
/**
  * @}
  */ 
...
#define IS_RCC_ETH_RTCCLK_SOURCE(SOURCE) (((SOURCE) == RCC_RTCCLKSource_LSE) || \
...
#define IS_RCC_ETH_MCO1SOURCE(SOURCE) (((SOURCE) == RCC_MCO1Source_HSI) || ((SOURCE) == RCC_MCO1Source_LSE) || \
...
#define IS_RCC_ETH_MCO2SOURCE(SOURCE) (((SOURCE) == RCC_MCO2Source_SYSCLK) || ((SOURCE) == RCC_MCO2Source_PLLI2SCLK)|| \
...
#define IS_RCC_ETH_CALIBRATION_VALUE(VALUE) ((VALUE) <= 0x1F)
/**
  * @}
  */ 
