...
#define IS_ETH_GPIO_PIN(PIN) ((((PIN) & (uint16_t)0x00) == 0x00) && ((PIN) != (uint16_t)0x00))
...
#define IS_ETH_GPIO_AF(AF)   (((AF) == GPIO_AF_RTC_50Hz)  || ((AF) == GPIO_AF_TIM14)     || \
...
void GPIO_Init(GPIO_TypeDef* GPIOx, ETH_GPIO_InitTypeDef* GPIO_InitStruct);
void GPIO_StructInit(ETH_GPIO_InitTypeDef* GPIO_InitStruct);
