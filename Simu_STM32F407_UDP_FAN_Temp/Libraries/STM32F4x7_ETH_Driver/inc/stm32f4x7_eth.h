...
#define VLAN_ETH_TAG                  4    /*!< optional 802.1q VLAN Tag */
#define LW_MIN_ETH_PAYLOAD          46    /*!< Minimum Ethernet payload size */
#define LW_MAX_ETH_PAYLOAD        1500    /*!< Maximum Ethernet payload size */
#define LW_JUMBO_FRAME_PAYLOAD    9000    /*!< Jumbo frame payload size */      
...
/**
  * @}
  */
#define	PHY_ANLPAR_100TXFD			      	 ((uint16_t)0x0100)		//* ���ӷ�֧��100Base-TXȫ˫��
#define	PHY_ANLPAR_100TX			         ((uint16_t)0x0080)		//* ���ӷ�֧��100Base-TX
#define	PHY_ANLPAR_10TXFD			         ((uint16_t)0x0040)		//* ���ӷ�֧��10Base-Tȫ˫��
#define PHY_ANLPAR_10TX				         ((uint16_t)0x0020)		//* ���ӷ�֧��10Base-TX
