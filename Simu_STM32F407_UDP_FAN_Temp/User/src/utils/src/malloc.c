...
//__align(4) uint8_t mem3base[MEM3_MAX_SIZE] __attribute__((at(0x10020000))); //内部CMM内存池
//内存管理表
...
//uint16_t mem3mapbase[MEM3_ALLOC_TABLE_SIZE] __attribute__((at(0X10020000+MEM3_MAX_SIZE)));	//内部CCM内存池MAP
//内存管理参数	   
